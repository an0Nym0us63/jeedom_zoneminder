        ...
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">{{Nom du monitor}}</label>
              <div class="col-md-3">
      ...
      <div id="infoNode" class="col-sm-6">
        <form class="form-horizontal">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">{{Fonction}}</label>
              <div class="col-md-3">
            ...
            <div class="form-group">
              <label class="col-md-2 control-label">{{Résolution}}</label>
              <div class="col-md-3">
              ...
              <label class="col-md-2 control-label">{{Activé}}</label>
              <div class="col-md-3">
