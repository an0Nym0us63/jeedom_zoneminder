...
<div class="row row-overflow">
        ...
        <div class="row">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">{{Nom de l'zoneminder}}</label>
                    <div class="col-md-3">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                    		<label class="col-md-2 control-label">{{Adresse IP du zoneminder}}</label>
                    		<div class="col-md-3">
                  ...
                  <div class="form-group">
                  <label class="col-md-2 control-label">{{URL pour l'envoi depuis zoneminder : }}</label>
                    <div class="col-md-3">
                  <?php
                  $url  = config::byKey('externalProtocol') . config::byKey('externalAddr') . ':' . config::byKey('externalPort') . config::byKey('externalComplement') . '/core/api/jeeApi.php?api=' . config::byKey('api') . '&type=zoneminder&variable1=valeur1&variable2=valeur2';
                  echo $url;
                  ?>
	...
	<legend>{{Informations et Commandes}}</legend>
        ...
        <a class="btn btn-default btn-sm" id="bt_addzoneminderInfo"><i class="fa fa-plus-circle"></i> {{Ajouter une info}}</a>
        <a class="btn btn-default btn-sm" id="bt_addzoneminderAction"><i class="fa fa-plus-circle"></i> {{Ajouter une commande}}</a><br/><br/>
